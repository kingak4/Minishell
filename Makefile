...
#    Updated: 2025/07/15 14:26:38 by kikwasni         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS = main/main.c Kamil/command/cd.c Kinga/read_line.c Kinga/lexing/clear_split.c Kinga/lexing/ft_split_mini.c Kinga/checkers/check1.c Kinga/checkers/check2.c Kinga/checkers/check3.c
OBJS = $(SRCS:.c=.o)
